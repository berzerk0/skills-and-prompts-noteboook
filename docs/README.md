...
third-party skill), prefer citing the source you checked over describing
what you expect to be true. [`cross-tool-notes.md`](cross-tool-notes.md) is
the model to follow: every load-bearing claim traces back to something
verifiable, and it says so when something is unverified rather than
asserting it anyway.
